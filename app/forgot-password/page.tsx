      ...
      <div className="w-full h-screen md:h-auto md:max-w-md bg-white/85 dark:bg-slate-900/80 backdrop-blur-xl md:rounded-3xl md:shadow-2xl md:border md:border-slate-200/70 dark:border-slate-700/60 flex flex-col px-6 pt-24 pb-10 md:py-10 md:px-10 relative z-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <div
              className="flex items-center w-full h-14 rounded-2xl border border-slate-300 dark:border-slate-700 bg-white/70 dark:bg-slate-900/60 focus-within:bg-white dark:focus-within:bg-slate-900 focus-within:ring-2 focus-within:ring-blue-500 overflow-hidden shadow-sm transition-all"
              dir="ltr"
            >
